...
export default function LoginPage() {
  ...
  return (
    <section className="section-container grid min-h-[calc(100vh-8rem)] items-stretch gap-8 py-10 lg:grid-cols-2">
      <div className="hidden rounded-3xl bg-rose-gradient p-10 text-white shadow-panel lg:flex lg:flex-col lg:justify-between relative overflow-hidden">
        <div 
        ...
        <div className="relative z-20">
          <p className="chip border-white/30 bg-white/15 text-white backdrop-blur-md">Account Access</p>
        ...
        <p className="relative z-20 text-sm text-white/80">AI recommendations based on real vendor performance.</p>
      </div>
