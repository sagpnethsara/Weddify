...
export default function RegisterPage() {
  ...
  return (
    <section className="section-container grid min-h-[calc(100vh-8rem)] items-stretch gap-8 py-10 lg:grid-cols-2">
      <div className="hidden rounded-3xl bg-green-gradient p-10 text-white shadow-panel lg:flex lg:flex-col lg:justify-between">
        <div>
          <p className="chip border-white/35 bg-white/15 text-white">Join Weddify</p>
